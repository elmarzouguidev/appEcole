                    ...
                    <div class="geodir-category-content-title fl-wrap">
                        <div class="geodir-category-content-title-item">
                            <h3 class="title-sin_map">
                                <a href="{{$ecole->getUrl()}}">{{$ecole->name}}</a>
                        ...
                        <div class="geodir-opt-list">
                            <ul class="no-list-style">
                                ...
                                <li>
                                    ...
                                    data-newlatitude="{{$ecole->getCoordinates()[0]['lat']}}" 
                                    data-newlongitude="{{$ecole->getCoordinates()[0]['lng']}}"
                                    data-newtitle="{{$ecole->name}}"
                                    data-slug="{{$ecole->getUrl()}}"
                                    >
                                        <i class="fal fa-map-marker-alt">
                                        </i>
                                        <span class="geodir-opt-tooltip">ouvrir localisation avec google map <strong>{{$loop->index+1}}</strong></span>
                                    </a>
                                </li>
