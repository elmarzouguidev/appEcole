                ...
                <div class="list-single-main-wrapper fl-wrap" id="sec2">
                    ...
                    <div class="list-single-main-item fl-wrap block_box" id="sec6">
                        ...
                        <div id="add-review" class="add-review-box">
                            ...
                            @endif
                            <form method="post" action="{{route('ecoles.actions.post',$ecole->slug)}}" id="add-comment" class="add-comment  custom-form" name="rangeCalc" >
                                @csrf
            ...
            <div class="col-md-4">
                ...
                <div class="box-widget-item fl-wrap block_box">
                    ...
                    <div class="box-widget">
                        <div class="box-widget-content">
                            <form class="add-comment custom-form" method="post" action="{{route('ecoles.actions.post',$ecole->slug)}}">
                                @csrf
                                <input type="hidden" value="{{$ecole->id}}" name="appEcole">
