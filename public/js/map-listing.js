...
(function ($) {
    ...
    function getEcoles() {
        ...
        httpRequest.open('GET', "http://localhost:8000/api/app-ecoles",false);
        httpRequest.send();
    ...
    function mainMap() {
       ...
       //  console.log(ecoles);
         ecoles.data.forEach(function(ecole,index){
             ...
             locations.push([locationData(ecole.slug, ecole.image, ecole.name, ecole.addresse, ecole.area, ecole.reviews, ecole.reviews, "open"  ),ecole.lat, ecole.lng, index, ecole.logo])
         });
